...
def test_call_to_return_json():
    # Define Variable
    language = "Python"
    company = "hack-my-insta"
    Itemid = 1
    price = 0.00
...
def callback(ch, method, properties, body):
    results = test_call_to_return_json()
    # send a message back
...
# contacts_msged = os.listdir(
#     folder_name_of_interest+'/'+folder_name_of_interest_contents[0])
...
#     contents_in_contact = os.listdir(
#         folder_name_of_interest+'/'+folder_name_of_interest_contents[0] + '/'+contacts)
#     first = folder_name_of_interest+'/' + \
#         folder_name_of_interest_contents[0] + '/'+contacts
...
# insta_df['Sent_msgs_per_sent_rxn'] = insta_df['Sent_msgs'] / \
#     insta_df['Sent_rxns']
...
# print('Sent Most Rxns ' +
#       str(int(analysis_tbl.Sent_rxns.loc['max'])) + ' to: ' + a)
# print('--------')
# print('Recieved Most Rxns ' +
#       str(int(analysis_tbl.Rec_rxns.loc['max'])) + ' from:', b)
# print('--------')
# print('Sent Most Msgs ' +
#       str(int(analysis_tbl.Sent_msgs.loc['max'])) + ' to: ' + c)
# print('--------')
# print('Recieved Most Msgs ' +
#       str(int(analysis_tbl.Rec_msgs.loc['max'])) + ' from: ' + d)
# print('--------')
...
# print('You have a mutual RXNship with ' +
#       str(len(insta_df_rxnship_mutual)) + '/' + str(len(insta_df)) + ' ppl u dm')
# print('You want a Rship with ' + str(len(insta_df_i_rsh_they_rxn)) +
#       '/' + str(len(insta_df)) + ' of em BUT THEY ONLY WANT A RXNSHIP')
# print(str(len(insta_df_they_more_excited)) + '/' + str(len(insta_df)) +
#       ' Are more excited to talk to you than you are to them')
# print('You may have trouble sparking a convo with ' +
#       str(len(insta_df_trbl_them_responding)) + '/' + str(len(insta_df)) + ' of ppl ')
# print(str(len(insta_df_they_excite_u)) + '/' +
#       str(len(insta_df)) + ' Excite You!')
# print(str(len(insta_df_they_bore_u)) + '/' +
#       str(len(insta_df)) + ' Bore each other')
